    ...
    private function lobbyLabels(string $locale): array
    {
        return match ($locale) {
            'en' => [
                ...
                'menu_info' => 'Hotel information', 'info_about' => 'About the hotel', 'info_policies' => 'Policies', 'info_faq' => 'Frequently asked questions', 'info_tab_about' => 'About', 'info_tab_faq' => 'FAQ',
            ...
            'ja' => [
                ...
                'menu_info' => 'ホテル情報', 'info_about' => 'ホテルについて', 'info_policies' => 'ご利用規定', 'info_faq' => 'よくあるご質問', 'info_tab_about' => 'ホテルについて', 'info_tab_faq' => 'FAQ',
            ...
            default => [
                ...
                'menu_info' => 'Informasi hotel', 'info_about' => 'Tentang hotel', 'info_policies' => 'Kebijakan', 'info_faq' => 'Pertanyaan yang sering diajukan', 'info_tab_about' => 'Tentang', 'info_tab_faq' => 'FAQ',
    ...
    private function labels(string $locale): array
    {
        return match ($locale) {
            'en' => [
                ...
                'room_details_question' => 'Show me more details and photos of :room',
            ...
            'ja' => [
                ...
                'view_details' => '詳細を見る',
                'room_details_question' => ':room の詳細と写真を見せてください',
                'book_now' => 'この部屋を予約',
            ...
            default => [
                ...
                'max_guests' => 'tamu',
                'chat_room_only' => 'Tanpa sarapan',
                'chat_night' => 'malam',
                'chat_no_availability' => 'Tidak ada kamar tersedia untuk tanggal tersebut.',
                ...
                'room_details_question' => 'Tunjukkan detail dan foto lengkap :room',
